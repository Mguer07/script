...
print ("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
print("Your quest takes you to the Forbiden Forest. This forest is said to be surrounded by evil creatures. Let's see how long you can last")
print ("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
print ("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
def profession():
    print("What is your class?",'\n',
          " press f for Ernest the Fighter",'\n',
          " press c for Mike the Cleric",'\n',
          " press m for Miguel The Wise Mage")
    pclass=input(">>>")
    if pclass =="f":
        Prof = Fighter()
    elif pclass=="c":
